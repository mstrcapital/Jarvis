...
fetched_at: "2026-01-27T05:28:24.355Z"
---
# Event: riskLevelChange

## Event Description[​](https://developers.binance.com/docs/derivatives/portfolio-margin/user-data-streams/Event-riskLevelChange)
...
## Event Name[​](https://developers.binance.com/docs/derivatives/portfolio-margin/user-data-streams/Event-riskLevelChange)

`RISK_LEVEL_CHANGE`

## Response Example[​](https://developers.binance.com/docs/derivatives/portfolio-margin/user-data-streams/Event-riskLevelChange)
